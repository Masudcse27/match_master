        ...
        <div class="container mt-5">
            ...
            <div>
                @if (count($my_team_squads)>0)
                    <a href="select.players" class="btn btn-primary">select playing XI</a>
                @elseif(\Carbon\Carbon::now()->format('H:i:s') > $match->start_time)
                    <a href="select.players" class="btn btn-primary">Update playing XI</a>
                @endif
